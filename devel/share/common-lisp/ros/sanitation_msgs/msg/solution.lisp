...
(cl:defmethod cl:initialize-instance :after ((m <solution>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'solution)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sanitation_msgs-msg:<solution> is deprecated: use sanitation_msgs-msg:solution instead.")))
